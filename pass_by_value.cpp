...
class Account
{
    ...
    public:
            ...
            void transfer_value(Account obj1,Account obj2,double ammount_transfer)
            {
                if(obj1.balance>2000.0)
                {
                    obj1.balance-=ammount_transfer;
                    obj2.balance+=ammount_transfer;
                    cout<<"The balance in transfer_value for obj1:"<<obj1.balance<<endl;
                    cout<<"The balance in transfer_value obj2:"<<obj2.balance<<endl;
                }
                else
